  ...
  Redactor.fn = $.Redactor.prototype = {
    ...
    image: function() {
      return {
        ...
        insertSubmit: function(json, direct, e) {
          // error callback
          if (typeof json.error != 'undefined') {
            this.modal.close();
            this.selection.restore();
        ...
        loadTemplates: function() {
          this.opts.modal = {
            imageEdit: String() +
              ...
              '<label class="redactor-image-link-option"><input type="checkbox" id="redactor-image-link-blank"> ' +
            ...
            image: String() +
              ...
              '<form class="image-upload-form" action="/redactor/upload/image/uploads" method="post" enctype="multipart/form-data">' +
              ...
              "$('.image-upload-form').submit(function(event) {" +
              "var url=$(this).attr('action');" +
              "$.ajax({url: url,type: $(this).attr('method'),dataType: 'JSON',data: new FormData(this),processData: false,contentType: false," +
              "success: function (data, status){" +
              "console.log(data);" +
              "}," +
              "error: function (xhr, desc, err){" +
